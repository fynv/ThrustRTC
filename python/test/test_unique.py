...
d_values_in =  trtc.device_vector_from_list([ 9, 8, 7, 6, 5, 4, 3], 'int32_t')
d_keys_out = trtc.device_vector('int32_t', 7)
d_values_out = trtc.device_vector('int32_t', 7)
count = trtc.Unique_By_Key_Copy(d_keys_in, d_values_in, d_keys_out, d_values_out)
...
d_keys_out = trtc.device_vector('int32_t', 7)
d_values_out = trtc.device_vector('int32_t', 7)
count = trtc.Unique_By_Key_Copy(d_keys_in, d_values_in, d_keys_out, d_values_out, trtc.EqualTo())
print (d_keys_out.to_host(0, count))
print (d_values_out.to_host(0, count))
