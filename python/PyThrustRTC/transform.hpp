...
static PyObject* n_transform(PyObject* self, PyObject* args)
{
	...
	if (TRTC_Transform(*vec_in,* vec_out, *op, begin_in, end_in, begin_out))
...
static PyObject* n_transform_binary(PyObject* self, PyObject* args)
{
	...
	size_t begin_in1 = (size_t)PyLong_AsLong(PyTuple_GetItem(args, 4));
	size_t end_in1 = (size_t)PyLong_AsLong(PyTuple_GetItem(args, 5));
	size_t begin_in2 = (size_t)PyLong_AsLong(PyTuple_GetItem(args, 6));
	size_t begin_out = (size_t)PyLong_AsLong(PyTuple_GetItem(args, 7));
	if(TRTC_Transform_Binary(*vec_in1, *vec_in2, *vec_out, *op, begin_in1, end_in1, begin_in2, begin_out))
		return PyLong_FromLong(0);
	else
		Py_RETURN_NONE;
}
...
static PyObject* n_transform_if(PyObject* self, PyObject* args)
{
	...
	TRTC_Transform_If(*vec_in, *vec_out, *op, *pred, begin_in, end_in, begin_out);
	return PyLong_FromLong(0);
}
...
static PyObject* n_transform_if_stencil(PyObject* self, PyObject* args)
{
	...
	if(TRTC_Transform_If_Stencil(*vec_in, *vec_stencil, *vec_out, *op, *pred, begin_in, end_in, begin_stencil, begin_out))
		return PyLong_FromLong(0);
	else
		Py_RETURN_NONE;
}
...
static PyObject* n_transform_binary_if_stencil(PyObject* self, PyObject* args)
{
	...
	size_t begin_in1 = (size_t)PyLong_AsLong(PyTuple_GetItem(args, 6));
	size_t end_in1 = (size_t)PyLong_AsLong(PyTuple_GetItem(args, 7));
	size_t begin_in2 = (size_t)PyLong_AsLong(PyTuple_GetItem(args, 8));
	...
	if(TRTC_Transform_Binary_If_Stencil(*vec_in1, *vec_in2, *vec_stencil, *vec_out, *op, *pred, begin_in1, end_in1, begin_in2, begin_stencil, begin_out))
		return PyLong_FromLong(0);
	else
		Py_RETURN_NONE;
}
