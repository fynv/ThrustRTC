...
static PyObject* n_transform(PyObject* self, PyObject* args)
{
	...
	TRTC_Transform(*ctx, *vec_in,* vec_out, op, begin_in, end_in, begin_out);
...
static PyObject* n_transform_binary(PyObject* self, PyObject* args)
{
	...
	TRTC_Transform_Binary(*ctx, *vec_in1, *vec_in2, *vec_out, op, begin_in1, end_in1, begin_in2, begin_out);
	return PyLong_FromLong(0);
}
...
static PyObject* n_transform_if_stencil(PyObject* self, PyObject* args)
{
	...
	TRTC_Transform_If_Stencil(*ctx, *vec_in, *vec_stencil, *vec_out, op, pred, begin_in, end_in, begin_stencil, begin_out);
	return PyLong_FromLong(0);
}
...
static PyObject* n_transform_binary_if_stencil(PyObject* self, PyObject* args)
{
	...
	TRTC_Transform_Binary_If_Stencil(*ctx, *vec_in1, *vec_in2, *vec_stencil, *vec_out, op, pred, begin_in1, end_in1, begin_in2, begin_stencil, begin_out);
	return PyLong_FromLong(0);
}
