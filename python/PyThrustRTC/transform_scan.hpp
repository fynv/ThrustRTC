...
static PyObject* n_transform_inclusive_scan(PyObject* self, PyObject* args)
{
	...
	if (TRTC_Transform_Inclusive_Scan(*vec_in, *vec_out, *unary_op, *binary_op, begin_in, end_in, begin_out))
...
static PyObject* n_transform_exclusive_scan(PyObject* self, PyObject* args)
{
	...
	if (TRTC_Transform_Exclusive_Scan(*vec_in, *vec_out, *unary_op, *init, *binary_op, begin_in, end_in, begin_out))
		return PyLong_FromLong(0);
	Py_RETURN_NONE;
}
