...
bool TRTC_Merge(const DVVectorLike& vec1, const DVVectorLike& vec2, DVVectorLike& vec_out, const Functor& comp, size_t begin1, size_t end1, size_t begin2, size_t end2, size_t begin_out)
{
...
bool TRTC_Merge(const DVVectorLike& vec1, const DVVectorLike& vec2, DVVectorLike& vec_out, size_t begin1, size_t end1, size_t begin2, size_t end2, size_t begin_out)
{
	Functor comp("Less");
	return TRTC_Merge(vec1, vec2, vec_out, comp, begin1, end1, begin2, end2, begin_out);
}

bool TRTC_Merge_By_Key(const DVVectorLike& keys1, const DVVectorLike& keys2, const DVVectorLike& value1, const DVVectorLike& value2, DVVectorLike& keys_out, DVVectorLike& value_out, const Functor& comp, size_t begin_keys1 , size_t end_keys1, size_t begin_keys2, size_t end_keys2, size_t begin_value1, size_t begin_value2, size_t begin_keys_out, size_t begin_value_out)
{
...
{
	Functor comp("Less");
	return TRTC_Merge_By_Key(keys1, keys2, value1, value2, keys_out, value_out, comp, begin_keys1, end_keys2, begin_keys2, end_keys2, begin_value1, begin_value2, begin_keys_out, begin_value_out);
}
