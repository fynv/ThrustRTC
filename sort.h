...
bool THRUST_RTC_API TRTC_Is_Sorted(TRTCContext& ctx, const DVVectorLike& vec, bool& result, size_t begin = 0, size_t end = (size_t)(-1));
bool THRUST_RTC_API TRTC_Is_Sorted(TRTCContext& ctx, const DVVectorLike& vec, const Functor& comp, bool& result, size_t begin = 0, size_t end = (size_t)(-1));
bool THRUST_RTC_API TRTC_Is_Sorted_Until(TRTCContext& ctx, const DVVectorLike& vec, size_t& result, size_t begin = 0, size_t end = (size_t)(-1));
bool THRUST_RTC_API TRTC_Is_Sorted_Until(TRTCContext& ctx, const DVVectorLike& vec, const Functor& comp, size_t& result, size_t begin = 0, size_t end = (size_t)(-1));
