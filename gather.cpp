...
bool TRTC_Gather(TRTCContext& ctx, const DVVector& vec_map, const DVVector& vec_in, DVVector& vec_out, size_t begin_map, size_t end_map, size_t begin_in, size_t begin_out)
{
...
bool TRTC_Gather_If(TRTCContext& ctx, const DVVector& vec_map, const DVVector& vec_stencil, const DVVector& vec_in, DVVector& vec_out, size_t begin_map, size_t end_map, size_t begin_stencil, size_t begin_in, size_t begin_out)
{
...
bool TRTC_Gather_If(TRTCContext& ctx, const DVVector& vec_map, const DVVector& vec_stencil, const DVVector& vec_in, DVVector& vec_out, const Functor& pred, size_t begin_map, size_t end_map, size_t begin_stencil, size_t begin_in, size_t begin_out)
{
	DVInt32 dvdelta_stencil((int)begin_stencil - (int)begin_map);
	DVInt32 dvdelta_in((int)begin_in - (int)begin_map);
	DVInt32 dvdelta_out((int)begin_out - (int)begin_map);
