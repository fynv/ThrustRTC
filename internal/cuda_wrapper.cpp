...
bool init_cuda()
{
	...
	cuDevicePrimaryCtxRetain = (decltype(cuDevicePrimaryCtxRetain))GetProcAddress(hinstLib, "cuDevicePrimaryCtxRetain");
	cuCtxCreate = (decltype(cuCtxCreate))GetProcAddress(hinstLib, "cuCtxCreate_v2");
	cuCtxSetCurrent = (decltype(cuCtxSetCurrent))GetProcAddress(hinstLib, "cuCtxSetCurrent");
	...
	cuDevicePrimaryCtxRetain = (decltype(cuDevicePrimaryCtxRetain))dlsym(handle, "cuDevicePrimaryCtxRetain");
	cuCtxCreate = (decltype(cuCtxCreate))dlsym(handle, "cuCtxCreate_v2");
	cuCtxSetCurrent = (decltype(cuCtxSetCurrent))dlsym(handle, "cuCtxSetCurrent");
