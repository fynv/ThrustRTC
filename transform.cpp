...
void TRTC_Transform_Binary(TRTCContext& ctx, const DVVector& vec_in1, const DVVector& vec_in2, DVVector& vec_out, const Functor& op, size_t begin_in1, size_t end_in1, size_t begin_in2, size_t begin_out)
{
...
void TRTC_Transform_If(TRTCContext& ctx, const DVVector& vec_in, DVVector& vec_out, const Functor& op, const Functor& pred, size_t begin_in, size_t end_in, size_t begin_out)
{
	DVInt32 dvdelta_out((int)begin_out - (int)begin_in);
...
void TRTC_Transform_If_Stencil(TRTCContext& ctx, const DVVector& vec_in, const DVVector& vec_stencil, DVVector& vec_out, const Functor& op, const Functor& pred, size_t begin_in, size_t end_in, size_t begin_stencil, size_t begin_out)
{
...
void THRUST_RTC_API TRTC_Transform_Binary_If_Stencil(TRTCContext& ctx, const DVVector& vec_in1, const DVVector& vec_in2, const DVVector& vec_stencil, DVVector& vec_out, const Functor& op, const Functor& pred, size_t begin_in1, size_t end_in1, size_t begin_in2, size_t begin_stencil, size_t begin_out)
{
	DVInt32 dvdelta_in2((int)begin_in2 - (int)begin_in1);
